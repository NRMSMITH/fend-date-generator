  ...
  return (
    <main>
      ...
      >
        ...
        <button className="button" onClick={(e) => closeModal()}>
          X
        </button>
      </Modal>
      <section>
        <button className="text-lg text-black font-semibold" onClick={(e) => displayDate(e)}>
          surprise me
        </button>
        <button className="px-4 py-1 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2" onClick={(e) => openModal()}>
          add new date!
        </button>
        <Link to="/dates">
